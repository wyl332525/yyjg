package com.kmzc.core.widget.bottomwidget;
...
public class BottomBarTab extends FrameLayout {
    ...
    public BottomBarTab(Context context, @DrawableRes int icon, CharSequence title) {
        this(context, null, icon, title,false);
    }

    public BottomBarTab(Context context, @DrawableRes int icon, CharSequence title,boolean isHORIZONTAL) {
        this(context, null, icon, title,isHORIZONTAL);

    }

    public BottomBarTab(Context context, AttributeSet attrs, int icon, CharSequence title,boolean isHORIZONTAL) {
        this(context, attrs, 0, icon, title,isHORIZONTAL);
    }

    public BottomBarTab(Context context, AttributeSet attrs, int defStyleAttr, int icon, CharSequence title,boolean isHORIZONTAL) {
