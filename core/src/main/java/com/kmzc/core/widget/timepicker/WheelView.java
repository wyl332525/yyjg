...
package com.kmzc.core.widget.timepicker;
...
public class WheelView extends View {
	...
	/** Additional width for items watch_dialog_layout */
	...
	/**
	 * Calculates desired height for watch_dialog_layout
	 * 
	 * @param layout
	 *            the source watch_dialog_layout
	 * @return the desired watch_dialog_layout height
	 */
	 ...
	 * @param widthSize the input watch_dialog_layout width
	 * @param mode the watch_dialog_layout mode
	...
	/**
	 * Creates layouts
	 * @param widthItems width of items watch_dialog_layout
	 * @param widthLabel width of label watch_dialog_layout
	 */
	...
	/**
	 * Draws value and label watch_dialog_layout
	 * @param canvas the canvas for drawing
	 */
