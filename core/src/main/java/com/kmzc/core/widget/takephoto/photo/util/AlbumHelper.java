...
public class AlbumHelper {
	...
	void buildImagesBucketList() {
		...
		String columns[] = new String[] { Media._ID, Media.BUCKET_ID,
				...
				Media.SIZE, Media.BUCKET_DISPLAY_NAME,Media.MIME_TYPE};
		...
		if (cur.moveToFirst()) {
			...
			int pictureTypeIndex = cur.getColumnIndexOrThrow(Media.MIME_TYPE);
			...
			do {
				...
				String pictureType = cur.getString(pictureTypeIndex);
				...
				imageItem.setImgName(name);
				imageItem.setImgType(pictureType);
