...
public class TimeItemFactory extends AssemblyRecyclerItemFactory<TimeItemFactory.CarItem> {
    ...
    public class CarItem extends AssemblyRecyclerItem<TimeValueBean>{
        TextView name,value,timeSelect,divider,flag_item;
        Context context;
        ...
        protected void onFindViews() {
            ...
            flag_item = (TextView) findViewById(R.id.flag_item);
        ...
        public void onYearMonthDayPicker() {
            ...
            picker.setOnDatePickListener(new DatePicker.OnYearMonthDayPickListener() {
                ...
                public void onDatePicked(String year, String month, String day) {
                    ...
                    //暂时注销
                    CarListPresenter.setParams(getData().getKey(),year+"-"+month+"-"+day);
//                onTimePicker();
                }
            });
