...
import com.kmzc.car.mvp.searchcar.gotoview.model.CarListBean;
 ...
 */
public class CarInfoOtherAdapter extends BaseAdapter{
    ...
    public CarInfoOtherAdapter(Activity activity, List<CarListBean> carListBeen) {
