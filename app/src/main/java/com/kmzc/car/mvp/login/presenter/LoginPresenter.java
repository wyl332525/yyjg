package com.kmzc.car.mvp.login.presenter;
...
import com.kmzc.car.mvp.login.update.BaseAutoUpdate;
...
//import com.kmzc.autoupdate.BaseAutoUpdate;
...
//        ,"COD_CHECKTYPE"
        name = new String[]{
                "COD_FUELTYPE",
                "COD_USEDQUALITY", "COD_CARDCOLOR",
                "COD_OILSUPPLY", "COD_CARMODE",
                "COD_REGION", "COD_DRIVEMODE",
                "COD_CARDTYPE", "COD_SPEEDCHANGER",
                "COD_AIRINFLOW", "COD_CHECKMODE",
                "COD_CHECKMETHOD","COD_NOTUSEDGKFREASON",
                "COD_ISSYJHQ"
...
//        }
    ...
    public void updateApk(String url) {
        new BaseAutoUpdate().UPdateAPK(url, context, "软件更新", new DialogInterface.OnClickListener() {
            @Override
